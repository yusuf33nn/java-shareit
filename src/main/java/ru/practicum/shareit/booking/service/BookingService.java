...
public interface BookingService {
    ...
    List<BookingDto> getBookerAllBookingsByState(Long bookerId, BookingState state);

    List<BookingDto> getOwnerAllBookingsByState(Long ownerId, BookingState state);
}
